	...
	"@graph": [
		{
			...
			url: CANONICAL,
			name: PAGE_TITLE,
			alternateName: ["suriya.xyz", "Kokkiligadda Surya Prakash Portfolio"],
		...
		},
		{
			"@type": "Person",
			"@id": PERSON_ID,
			name: "Kokkiligadda Surya Prakash",
...
export const Route = createRootRoute({
	head: () => ({
		meta: [
			...
			{ name: "application-name", content: "suriya.xyz" },
			{ name: "author", content: "Kokkiligadda Surya Prakash" },
			{ name: "publisher", content: "Kokkiligadda Surya Prakash" },
			...
			{ property: "og:site_name", content: "suriya.xyz" },
		...
		links: [
			...
			{ rel: "mask-icon", href: "/favicon.svg?v=2", color: "#ede9e0" },
